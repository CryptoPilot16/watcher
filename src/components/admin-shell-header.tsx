...
type AdminShellHeaderProps = {
  activeTab: 'axiom' | 'work' | 'tasks' | 'project' | 'roadmap' | 'docs' | 'settings';
};

const tabs = [
  { id: 'axiom', label: 'axiom', href: '/axiom' },
  { id: 'work', label: 'work', href: '/axiom/work' },
  { id: 'tasks', label: 'tasks', href: '/axiom/tasks' },
  { id: 'project', label: 'project', href: '/axiom/project' },
  { id: 'roadmap', label: 'roadmap', href: '/axiom/roadmap' },
  { id: 'docs', label: 'docs', href: '/axiom/docs' },
      ...
      <div className="flex flex-col gap-3 p-3 sm:flex-row sm:items-start sm:justify-between sm:p-5">
        <div className="flex min-w-0 items-center gap-3">
          <Link href="/axiom" className="shrink-0">
            <img src="/watch-logo.png?v=20260518f" alt="WATCHER" className="h-9 w-9 rounded sm:h-12 sm:w-12" />
          </Link>
