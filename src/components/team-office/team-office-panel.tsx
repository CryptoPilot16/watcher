      ...
      <div className="hidden flex-wrap items-start justify-between gap-3 px-1 sm:flex sm:px-0">
        <div>
          ...
          <div className="mt-2 hidden max-w-3xl text-xs leading-6 text-[var(--watch-text-muted)] sm:block sm:text-[13px]">
            Assigned workers gather at the middle table, active lanes move to their desks with a green diamond, idle unassigned lanes stay in the middle line, and recent deliveries queue at PILOT’s desk.
          </div>
        </div>
        ...
        <div className="rounded-xl border border-[var(--watch-panel-border)] bg-[rgba(0,0,0,0.22)] p-4">
          ...
          <div className="mt-3 grid gap-2 sm:grid-cols-2">
            {([
              ...
              { status: 'idle', title: 'idle', desc: 'assigned workers wait at the common table, unassigned lanes wait in the middle line' },
